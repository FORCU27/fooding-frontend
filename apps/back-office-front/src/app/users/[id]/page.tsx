...
import { Box, Button, Paper, Typography, Chip, Stack } from '@mui/material';
import { AdminUserResponse, AdminUpdateUserRequest, userApi } from '@repo/api/admin';
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
        <Button startIcon={<ArrowBack />} onClick={() => router.push('/users')} variant='outlined'>
          목록으로
        </Button>
      ...
      <DeleteConfirmDialog
        ...
        description={
          userToDelete
            ? `정말로 '${userToDelete.nickname || userToDelete.email}' 사용자를 삭제하시겠습니까?`
            : ''
        }
      />
    </Box>
