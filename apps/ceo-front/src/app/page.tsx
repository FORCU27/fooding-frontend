        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg md:text-xl mb-8 text-gray-600">매장 운영부터 고객 관리까지, 모든 것을 한 번에</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="p-6">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                  {serviceItems.map((item) => (
                    ...
                    >
                      <div className={`w-14 h-14 rounded-full ${item.iconBg} flex items-center justify-center text-2xl`}>
                        <span className={item.color}>{item.icon}</span>
                      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="border border-gray-200 rounded-lg bg-white shadow-sm hover:shadow-md transition-shadow">
                <div className="p-6">
                  ...
                  <p className="text-sm text-gray-600">매장 매출을 분석하고 인사이트를 제공합니다</p>
                </div>
              </div>
          ...
          <div className="lg:col-span-1 space-y-6">
              ...
              <div className="border border-gray-200 rounded-lg bg-white shadow-sm">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="flex justify-between items-center pt-2">
                    ...
                    <Link href="/login" className="text-sm text-red-600 hover:text-red-700 transition-colors font-medium">
                      회원가입
                    </Link>
                  </div>
                </div>
              ...
              <div key={app.title} className="border border-gray-200 rounded-lg bg-white shadow-sm">
                <div className="p-6 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    <div className={`w-8 h-8 ${app.color} rounded-lg flex items-center justify-center text-white text-sm`}>⬇️</div>
                    <div>
            ...
            <div className="border border-gray-200 rounded-lg bg-white shadow-sm">
              <div className="p-6 border-b border-gray-100">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-red-500 rounded-lg flex items-center justify-center text-white text-sm">❓</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {['사장님 앱', '웨이팅', '예약', '쿠폰관리', '매출분석', '고객관리'].map((link) => (
                    <a key={link} href="#" className="block text-gray-300 hover:text-red-400 transition-colors">
                      {link}
                    </a>
                  ))}
                </div>
          ...
          <div className="py-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="flex flex-wrap gap-6 lg:justify-end">
                <a href="#" className="text-sm text-gray-300 hover:text-red-400 transition-colors flex items-center gap-1">
                  서비스 이용약관
            ...
            <div className="text-center mt-8 pt-8 border-t border-gray-700">
              <p className="text-sm text-gray-400">&copy; 2025 주식회사 푸딩. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
