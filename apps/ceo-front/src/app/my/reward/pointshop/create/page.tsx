...
interface PointShopCreatePageProps {
  originValue?: CreateStorePointShopItemBody;
}

const PointShopCreatePage = ({ originValue }: PointShopCreatePageProps) => {
  ...
  const onSubmit = async (data: CreateStorePointShopItemBody) => {
