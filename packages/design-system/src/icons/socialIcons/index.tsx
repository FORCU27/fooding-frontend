...
export function NaverIcon({ size = 20, color = 'none', fill = '#FFFFFF', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function KakaoIcon({ size = 20, color = 'none', fill = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function AppleIcon({ size = 20, color = 'none', fill = '#000000', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GoogleIcon({ size = 24, fill = 'none', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
